...
const scenes: SceneScript[] = [
  {
    name: "scene-1-hook",
    script: "I stopped writing code six months ago. My apps have never been better.",
    direction: "deadpan comedic, like a confession that's also a flex",
  },
  {
    name: "scene-2-body",
    script: "Vibe coding. You describe what you want. AI builds it. No semicolons. No suffering. Just vibes.",
    direction: "enthusiastic and slightly unhinged, like an infomercial host who actually believes it",
  },
  {
    name: "scene-3-cta",
    script: "The future of coding isn't code. It's a really good description of what you want for lunch. I mean your app.",
    direction: "building up dramatically then breaking into a laugh at the end",
  },
];
